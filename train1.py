...
class MM_PinNet(nn.Module):
    def __init__(self, max_pins=MAX_PINS, max_name_len=MAX_NAME_LEN, vocab_size=VOCAB_SIZE, d_model=256, nhead=8, num_layers=2):
        ...
        # ----------------------------
        # 输出头
        self.pin_lstm = nn.LSTM(d_model, d_model//2, bidirectional=True, batch_first=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--image', type=str, default='./dataset/val/images/chip_0009.png')
